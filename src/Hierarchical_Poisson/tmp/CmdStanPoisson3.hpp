...
namespace CmdStanPoisson3_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "/home/dfish/.julia/dev/MCMCBenchmarks/Examples/Hierarchical_Poisson/tmp/CmdStanPoisson3.stan");
    reader.add_event(24, 22, "end", "/home/dfish/.julia/dev/MCMCBenchmarks/Examples/Hierarchical_Poisson/tmp/CmdStanPoisson3.stan");
    return reader;
}

class CmdStanPoisson3_model : public prob_grad {
private:
        int N;
        std::vector<int> y;
        int Ns;
        ...
        std::vector<double> x;
public:
    CmdStanPoisson3_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "CmdStanPoisson3_model_namespace::CmdStanPoisson3_model";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "CmdStanPoisson3_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef CmdStanPoisson3_model_namespace::CmdStanPoisson3_model stan_model;
